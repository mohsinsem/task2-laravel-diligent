...
class DistrictsController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            $query=Districts::with('division.province')->orderBy('id','desc');
            ...
            ->AddColumn('province_name',function($record){
                return   isset($record->division->province->name) ? $record->division->province->name : 'N/A';
            })
            ->AddColumn('division_name',function($record){
                return  isset($record->division->name) ? $record->division->name : 'N/A';
            })
