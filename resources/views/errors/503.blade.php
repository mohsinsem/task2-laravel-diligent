		  ...
		  <div class="col-lg-7 mx-auto text-white">
			<div class="row align-items-center d-flex flex-row">
			  ...
			  <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
				<h2>SORRY!</h2>
                <h3 class="font-weight-light">SERVICE UNAVAILABLE.</h3>
            </div>
			</div>
			<div class="row mt-5">
   ...
   <head>
      ...
      <style>
         ...
         * {
         ...
         .maintenance {
         background-image: url({{url('public/assets/images/maintenance_bg.png')}});
               ...
               <div class="row flex-grow">
                  <div class="maintenance">
                     <div class="maintenance_contain">
                        <img src="{{url('public/assets/images/main-vector.png')}}" alt="maintenance">
                        <div class="pp-infobox-title-wrapper">
                           <h3 class="pp-infobox-title"></h3>
                        </div>
                        <div class="pp-infobox-description">
                           {!!$record->MaintenanceText!!}
                        </div>
                     </div>
                  </div>
               </div>
